...
<form method="post">
    Tên NCC:<br>
    <input type="text" name="ten" value="<?= htmlspecialchars($_POST['ten'] ?? '') ?>" required><br><br>

    SĐT:<br>
    <input type="text" name="sdt" value="<?= htmlspecialchars($_POST['sdt'] ?? '') ?>"><br><br>

    Địa chỉ:<br>
    <input type="text" name="diachi" value="<?= htmlspecialchars($_POST['diachi'] ?? '') ?>"><br><br>
